...
namespace HOTPIZZA.Areas.Admin
{
    public class PhanQuyensController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "IdPhanQuyen,TenPhanQuyen")] PhanQuyen phanQuyen)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "IdPhanQuyen,TenPhanQuyen")] PhanQuyen phanQuyen)
        {
            if (ModelState.IsValid)
            {
